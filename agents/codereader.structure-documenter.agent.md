...
- overview.md, architecture.md, data-flow.md, modules/*.md は全て日本語で記述する
- Mermaid図のラベルやノード名も可能な限り日本語を使用する
- 技術用語や固有名詞（ファイル名、関数名、クラス名、ライブラリ名など）は英語のまま使用してよい
- 全ての説明文、見出し、コメントは日本語で記述する
