...
- 調査結果のドキュメント（structure.md, entrypoints.md, components.md, dataflow.md, functions-list.md, algorithms.md）は全て日本語で記述する
- 技術用語や固有名詞（ファイル名、関数名、変数名、ライブラリ名など）は英語のまま使用してよい
- 説明文、コメント、分析結果は全て日本語で記述する
